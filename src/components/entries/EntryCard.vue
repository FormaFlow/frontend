    ...
    <div class="flex items-start justify-between">
      <div class="flex-1 min-w-0">
        ...
        <div class="text-xs text-gray-500 dark:text-gray-400">
          ...
          <p
              class="h-4 truncate text-gray-400"
              :class="{ invisible: !relativeCreatedAt }"
              data-testid="entry-relative-time"
          >
            <template v-if="relativeCreatedAt">({{ relativeCreatedAt }})</template>
